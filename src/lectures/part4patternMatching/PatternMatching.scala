...
val x= random.nextInt(10)
  ...
  val greeting = bob match{
    case Person(n,a) if a< 21 => s"Hi my name is $n and I am $a years old and I can't drink in US"
  ...
  3. type of pattern match expression? unified type of all the types in all the case
